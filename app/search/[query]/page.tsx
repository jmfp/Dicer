    ...
    <div>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 mt-5 mx-5 gap-5 content-center mb-5">
            {games.map(async(game: any, idx: number) => {
                ...
                const img = cover && cover[0] && cover[0].image_id && cover[0].image_id != undefined && cover[0].status != 400 ?`https://images.igdb.com/igdb/image/upload/t_1080p/${cover[0].image_id}.jpg` : "/images/hero.png"
                return(

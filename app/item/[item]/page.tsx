  ...
  return (
    <div>
      ...
      <div className="p-6">
        <LitContainer>
          <div className="flex flex-col">
            <div className="flex flex-row max-sm:flex-col">
              <Image src={coverUrl} height={200} width={200} alt={games[0].name} className="size-[800px] rounded-tl-lg rounded-bl-lg border-r-2 border-primary max-sm:rounded-tr-lg max-sm:border-b-2 max-sm:border-r-0 max-sm:rounded-bl-none max-sm:height-[400px]"/>
        ...
        {video ? 
        <LitContainer>
          <iframe src={`https://www.youtube.com/embed/${video[0].video_id}`} allowFullScreen className="w-full h-[900px] rounded-lg max-sm:height-[450px]"/>
        </LitContainer> : null}
